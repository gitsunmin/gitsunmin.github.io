...
- TOC
  ### **1. CFCs**
  - 2019: React, Angular, Vue 등 모든 프레임워크를 지원하는 방법 (DOM)
    - InfiniteGrid 1.x, Flicking 2.x
    - InfiniteGrid, Flicking 3.0
  - 프레임워크를 지원하는 방법
  ### **2. CFCs DOM (DEVIEW 2019)**
  - UI에 초점을 두는 CFCs DOM Concept
  - CFCs DOM 개발 지연 상황
  ### **3. 함수 컴포넌트의 개선과 Reactive Component**
  - 2019 ~ : 함수 컴포넌트와 UI보다 기능에 초점을 두는 Hooks의 등장
  - 함수 컴포넌트에서 사용할 수 있는 Reactive Component
  - 프레임워크별 Reactive Component
  - 2020: egjs의 함수 컴포넌트 지원 시작 및 같은 실수를 반복하는 ImReady
  - ImReady를 통한 프레임워크별 Reactive component 라이프사이클
  ### **4. CFCs Reactive 모듈**
  - UI보다 기능에 초점을 두는 CFCs Reactive Concept
  - 어떻게 공통화를 할 수 있었는가?
...
- TOC
  ...
  ### **클로바노트의 웹 기술들**
  - 오프라인 지원
    - 오프라인 웹을 지원하기 위해 PWA를 설정하는 방법
    - 신규 서버를 배포 후 오프라인 앱에 업데이트를 가능하게 하는 방법 들을 공유합니다.
  - 반응형 UX
    - 반응형 ux 로 개발했던 방법을 공유합니다.
  - 줌 서비스 연동
    - 줌 미팅의 오디오 데이터를 실시간으로 가져와서 클로바노트와 연결했던 방법을 공유 합니다.
  - 기타 기술들
    - 모노레포, 아토믹패턴, 리코일등 이미 많이 소개된 기술을 어떻게 클로바노트에서 적용하며 잘 유지하고 있는지 공유합니다.
  ### **클로바노트 웹팀의 개발 문화**
  - Perfect이 아닌 Better를 만들기 위한 팀의 개발 문화 몇가지를 소개합니다.
...
- TOC
  ...
  - Onsite Merchandazing System
  - Content Management Platform
  ### **2. Micro-Frontend (MFE)**
  - Micro-Frontend의 기본 구조
  - 런타임 원격 코드 동적 로딩
  - Standard Monolith SSR
  - Module Federation 과 SSR
  - 우리가 원했던 방식
  - 런타임 원격 코드 동적 로딩
  - 남은 문제
  ### **3. Module Registry**
  - demo
  ### **4. Rendering walk-though**
  - Rendering walk-though
  - Page Code
  - 이 변화를 통해 얻은 것
  ### **5. MFE를 위한 캐시전략**
  - 무엇을 캐시할 것인가?
