...
import Content from '@til/functional_programing/algebraic-data-type.mdx';
...
const Component = () => (
  <Content
    components={{
      ...
      img: (props) => <img {...props} src={'/modules/til/functional_programing/' + props.src?.split('/').pop()} className="rounded-lg shadow-md my-4" />,
      pre: (el) => {
...
export const Route = createFileRoute('/_layout/til/functional_programing/algebraic-data-type')({
  component: Component,
});
