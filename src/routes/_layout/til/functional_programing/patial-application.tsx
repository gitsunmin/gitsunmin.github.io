...
import Content from '@til/functional_programing/patial-application.mdx';
...
export const Route = createFileRoute('/_layout/til/functional_programing/patial-application')({
  component: Component,
});
