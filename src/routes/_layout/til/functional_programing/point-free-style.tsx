...
import Content from '@til/functional_programing/point-free-style.mdx';
...
export const Route = createFileRoute('/_layout/til/functional_programing/point-free-style')({
  component: Component,
});
