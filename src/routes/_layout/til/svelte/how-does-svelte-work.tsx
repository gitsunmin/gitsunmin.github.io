...
import Content from '@til/svelte/how-does-svelte-work.mdx';
...
const Component = () => (
  <Content
    components={{
      ...
      img: (props) => <img {...props} src={'/modules/til/svelte/' + props.src?.split('/').pop()} className="rounded-lg shadow-md my-4" />,
      pre: (el) => {
...
export const Route = createFileRoute('/_layout/til/svelte/how-does-svelte-work')({
  component: Component,
});
