...
import Content from '@til/browser/checking-the-console-log-in-mobile-chrome.mdx';
...
const Component = () => (
  <Content
    components={{
      ...
      img: (props) => <img {...props} src={'/modules/til/browser/' + props.src?.split('/').pop()} className="rounded-lg shadow-md my-4" />,
      pre: (el) => {
...
export const Route = createFileRoute('/_layout/til/browser/checking-the-console-log-in-mobile-chrome')({
  component: Component,
});
