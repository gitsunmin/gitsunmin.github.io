...
import Content from '@til/cs/how-to-check-system-uptime-and-system-load.mdx';
...
const Component = () => (
  <Content
    components={{
      ...
      img: (props) => <img {...props} src={'/modules/til/cs/' + props.src?.split('/').pop()} className="rounded-lg shadow-md my-4" />,
      pre: (el) => {
...
export const Route = createFileRoute('/_layout/til/cs/how-to-check-system-uptime-and-system-load')({
  component: Component,
});
