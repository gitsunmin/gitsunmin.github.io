...
import Content from '@til/react/how-to-check-children-in-react-component.mdx';
...
export const Route = createFileRoute('/_layout/til/react/how-to-check-children-in-react-component')({
  component: Component,
});
