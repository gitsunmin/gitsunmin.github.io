...
import Content from '@til/react/the-difference-between-useEffect-and-useLayoutEffect.mdx';
...
const Component = () => (
  <Content
    components={{
      ...
      img: (props) => <img {...props} src={'/modules/til/react/' + props.src?.split('/').pop()} className="rounded-lg shadow-md my-4" />,
      pre: (el) => {
...
export const Route = createFileRoute('/_layout/til/react/the-difference-between-useEffect-and-useLayoutEffect')({
  component: Component,
});
