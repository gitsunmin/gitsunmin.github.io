...
import Content from '@til/database/basic-of-partitioning.mdx';
...
const Component = () => (
  <Content
    components={{
      ...
      img: (props) => <img {...props} src={'/modules/til/database/' + props.src?.split('/').pop()} className="rounded-lg shadow-md my-4" />,
      pre: (el) => {
...
export const Route = createFileRoute('/_layout/til/database/basic-of-partitioning')({
  component: Component,
});
