...
import Content from '@til/algorithm/depth-first-search-algorithm.mdx';
...
const Component = () => (
  <Content
    components={{
      ...
      img: (props) => <img {...props} src={'/modules/til/algorithm/' + props.src?.split('/').pop()} className="rounded-lg shadow-md my-4" />,
      pre: (el) => {
...
export const Route = createFileRoute('/_layout/til/algorithm/depth-first-search-algorithm')({
  component: Component,
});
