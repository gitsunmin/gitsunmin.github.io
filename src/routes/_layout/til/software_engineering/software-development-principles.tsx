...
import Content from '@til/software_engineering/software-development-principles.mdx';
...
const Component = () => (
  <Content
    components={{
      ...
      img: (props) => <img {...props} src={'/modules/til/software_engineering/' + props.src?.split('/').pop()} className="rounded-lg shadow-md my-4" />,
      pre: (el) => {
...
export const Route = createFileRoute('/_layout/til/software_engineering/software-development-principles')({
  component: Component,
});
