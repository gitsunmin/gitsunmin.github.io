...
import Content from '@til/javascript/shallow-merge-and-deep-merge.mdx';
...
export const Route = createFileRoute('/_layout/til/javascript/shallow-merge-and-deep-merge')({
  component: Component,
});
