...
import Content from '@til/javascript/promise-all-settled-and-promise-all.mdx';
...
const Component = () => (
  <Content
    components={{
      ...
      img: (props) => <img {...props} src={'/modules/til/javascript/' + props.src?.split('/').pop()} className="rounded-lg shadow-md my-4" />,
      pre: (el) => {
...
export const Route = createFileRoute('/_layout/til/javascript/promise-all-settled-and-promise-all')({
  component: Component,
});
