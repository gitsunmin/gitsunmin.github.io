...
import Content from '@til/typescript/ts-ignore-and-ts-expect-error.mdx';
...
export const Route = createFileRoute('/_layout/til/typescript/ts-ignore-and-ts-expect-error')({
  component: Component,
});
