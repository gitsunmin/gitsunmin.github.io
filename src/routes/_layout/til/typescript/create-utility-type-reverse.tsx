...
import Content from '@til/typescript/create-utility-type-reverse.mdx';
...
export const Route = createFileRoute('/_layout/til/typescript/create-utility-type-reverse')({
  component: Component,
});
