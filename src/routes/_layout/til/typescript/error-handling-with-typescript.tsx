...
import Content from '@til/typescript/error-handling-with-typescript.mdx';
...
const Component = () => (
  <Content
    components={{
      ...
      img: (props) => <img {...props} src={'/modules/til/typescript/' + props.src?.split('/').pop()} className="rounded-lg shadow-md my-4" />,
      pre: (el) => {
...
export const Route = createFileRoute('/_layout/til/typescript/error-handling-with-typescript')({
  component: Component,
});
