...
import Content from '@til/experience/garden9-2023/index.mdx';
...
const Component = () => (
  <Content
    components={{
      ...
      img: (props) => <img {...props} src={'/modules/til/experience/garden9-2023/' + props.src?.split('/').pop()} className="rounded-lg shadow-md my-4" />,
      pre: (el) => {
...
export const Route = createFileRoute('/_layout/til/experience/garden9-2023/')({
  component: Component,
});
