...
import Content from '@til/html/good-image-files-on-the-web-SVG.mdx';
...
const Component = () => (
  <Content
    components={{
      ...
      img: (props) => <img {...props} src={'/modules/til/html/' + props.src?.split('/').pop()} className="rounded-lg shadow-md my-4" />,
      pre: (el) => {
...
export const Route = createFileRoute('/_layout/til/html/good-image-files-on-the-web-SVG')({
  component: Component,
});
