...
import Content from '@til/testing/monkey-testing-and-gorilla-testing.mdx';
...
const Component = () => (
  <Content
    components={{
      ...
      img: (props) => <img {...props} src={'/modules/til/testing/' + props.src?.split('/').pop()} className="rounded-lg shadow-md my-4" />,
      pre: (el) => {
...
export const Route = createFileRoute('/_layout/til/testing/monkey-testing-and-gorilla-testing')({
  component: Component,
});
