...
import Content from '@til/testing/false-positive-and-false-negative.mdx';
...
export const Route = createFileRoute('/_layout/til/testing/false-positive-and-false-negative')({
  component: Component,
});
