...
import Content from '@til/frontend_framework/difference-between-csrand-ssr.mdx';
...
export const Route = createFileRoute('/_layout/til/frontend_framework/difference-between-csrand-ssr')({
  component: Component,
});
