...
import Content from '@til/frontend_framework/how-to-use-browserslist-on-nextjs.mdx';
...
const Component = () => (
  <Content
    components={{
      ...
      img: (props) => <img {...props} src={'/modules/til/frontend_framework/' + props.src?.split('/').pop()} className="rounded-lg shadow-md my-4" />,
      pre: (el) => {
...
export const Route = createFileRoute('/_layout/til/frontend_framework/how-to-use-browserslist-on-nextjs')({
  component: Component,
});
