...
import Content from '@til/git/lightweight-tag-and-annotated-tag.mdx';
...
const Component = () => (
  <Content
    components={{
      ...
      img: (props) => <img {...props} src={'/modules/til/git/' + props.src?.split('/').pop()} className="rounded-lg shadow-md my-4" />,
      pre: (el) => {
...
export const Route = createFileRoute('/_layout/til/git/lightweight-tag-and-annotated-tag')({
  component: Component,
});
