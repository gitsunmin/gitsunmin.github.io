...
import Content from '@til/graphql/thinking-in-graphs.mdx';
...
const Component = () => (
  <Content
    components={{
      ...
      img: (props) => <img {...props} src={'/modules/til/graphql/' + props.src?.split('/').pop()} className="rounded-lg shadow-md my-4" />,
      pre: (el) => {
...
export const Route = createFileRoute('/_layout/til/graphql/thinking-in-graphs')({
  component: Component,
});
