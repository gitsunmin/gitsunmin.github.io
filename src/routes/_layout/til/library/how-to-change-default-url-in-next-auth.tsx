...
import Content from '@til/library/how-to-change-default-url-in-next-auth.mdx';
...
const Component = () => (
  <Content
    components={{
      ...
      img: (props) => <img {...props} src={'/modules/til/library/' + props.src?.split('/').pop()} className="rounded-lg shadow-md my-4" />,
      pre: (el) => {
...
export const Route = createFileRoute('/_layout/til/library/how-to-change-default-url-in-next-auth')({
  component: Component,
});
