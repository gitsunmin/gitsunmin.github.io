...
import Content from '@til/editor/autocomplete-commit-message-in-vscode-with-copilot.mdx';
...
const Component = () => (
  <Content
    components={{
      ...
      img: (props) => <img {...props} src={'/modules/til/editor/' + props.src?.split('/').pop()} className="rounded-lg shadow-md my-4" />,
      pre: (el) => {
...
export const Route = createFileRoute('/_layout/til/editor/autocomplete-commit-message-in-vscode-with-copilot')({
  component: Component,
});
