...
import Content from '@til/css/break-afeter-and-before-and-inside.mdx';
...
const Component = () => (
  <Content
    components={{
      ...
      img: (props) => <img {...props} src={'/modules/til/css/' + props.src?.split('/').pop()} className="rounded-lg shadow-md my-4" />,
      pre: (el) => {
...
export const Route = createFileRoute('/_layout/til/css/break-afeter-and-before-and-inside')({
  component: Component,
});
