...
css에서 object-fit은 \`<img />\`나 \`<video />\`와 같은 css로 위치나 크기는 바꿀 수 있지만, 내부 컨텐츠에는 영향을 줄 수 없는 요소를 다룰 때 사용하며, 컨텐츠의 크기를 어떻게 맞출 것인지를 지정합니다.
...
## \`scale-down\`
\`none\`과 \`contain\`중에 컨텐츠의 크기를 더 작게 만드는 것을 적용합니다.
`;export{n as default};
