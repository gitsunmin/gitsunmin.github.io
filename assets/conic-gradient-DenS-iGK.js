...
### \`<position>\`
중심점을 나타내는 값입니다. 기본값은 center입니다. 이 position은 css의 [background-position](/css/background-position)과 같은 형식으로 사용됩니다.
...
- [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/gradient/conic-gradient)
`;export{n as default};
