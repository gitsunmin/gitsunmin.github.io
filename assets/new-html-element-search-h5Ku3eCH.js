const n=`# New HTML Element: search
...
> Example 1
아래의 예시는 \`<form>\` Element를 감싸기 위해서 \`<search>\` Element를 사용하였습니다.
\`\`\`html
<search>
...
이 \`<search>\` Element는 2023년 5월 기준으로, 추가된지 얼마 되지 않는 스펙이기 때문에, 모든 브라우저에서 제공되지는 않습니다. 이 점을 고려하여 role="search"를 사용하는 방법도 좋은 방법입니다. 물론 점차 \`<search>\` Element의 사용 하는것이 좋습니다.`;export{n as default};
