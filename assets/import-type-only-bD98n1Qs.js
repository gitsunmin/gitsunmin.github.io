const t=`# Import type only

Typescript에서 TS -> JS로 컴파일할 때, Type들은 모두 사용하지 않게 되는데, 부득이하게, export, import를 해서 사용하는 경우가 많습니다.
...
[typescript playground](https://www.typescriptlang.org/play)에서 테스트 가능합니다.`;export{t as default};
