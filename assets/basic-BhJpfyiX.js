...
- _메타데이터_: 데이터를 설명하는 데이터 예를 들어, HTML은 데이터입니다. 그리고 HTML의 \`<head>\` 안에는 문서 작성자나 문서 요약과 같이 문서를 설명하는 데이터, 즉 메타데이터를 넣을 수 있습니다.
- Global attributes: 모든 HTML 요소에 사용할 수 있는 속성
  ...
  - accesskey: 요소에 키보드 단축키를 지정합니다.
    - 사용 예시: \`<button accesskey="b">버튼</button>\`
    - 운영체제, 브라우저에 따라 단축키를 사용하는 방법이 다릅니다.
    - 예시로서 Mac + Chrome에서는 \`control + option + b\`를 누르면 버튼 클릭 이벤트와 동일한 이벤트가 발생합니다.
...
[책깔피](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes)
