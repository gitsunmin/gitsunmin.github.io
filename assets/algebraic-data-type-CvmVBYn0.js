const n=`# Algebraic data type

Algebraic이라는 단어는 한국어로 \`대수학\`이라고 번역할 수 있습니다. 즉, 대수학적 데이터 타입에 대해서 공부할 것을 간단하게 정리 해 보겠습니다.   
...
Algebraic data type이라고 해서 모든 대수학의 이론을 이용하여 data type을 설명하는 것은 아니며, \`합\`과 \`곱\`이라는 두 가지 기본적인 대수적 연산을 데이터 타입에 적용하는 것입니다. 여기서 이야기하는 \`합\`과 \`곱\`은 다음과 같은 의미를 지닙니다.
