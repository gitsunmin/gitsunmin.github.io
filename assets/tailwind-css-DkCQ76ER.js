...
## 개요
TailwindCSS의 **Transition Property**는 요소의 스타일 변경 시 적용되는 속성(transition property)을 지정할 수 있게 해주는 유틸리티 클래스입니다. 이를 활용하면 특정 속성만 전환되도록 설정하거나, 기본적으로 모든 속성이 전환되도록 지정할 수 있습니다.
...
transition-property는 CSS의 transition-property 속성과 동일한 역할을 수행합니다.
...
\`\`\`
	•	transition-colors: 배경색과 관련된 속성만 전환.
...
\`\`\`
	•	transition-transform: 변형 관련 속성(transform)에만 전환 효과 적용.
...
\`\`\`
	•	transition-all: 모든 속성에 전환 효과 적용.
	•	다중 호버 효과: 그림자, 투명도, 크기 변화 동시에 적용.
